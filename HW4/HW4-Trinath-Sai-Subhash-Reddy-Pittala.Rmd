...
The coefficient for dep_delay suggests that for every unit increase in dep_delay, arr_delay decreases by 3.490e+01 units. The coefficient for dep_delay2 indicates that for every unit increase in dep_delay squared, arr_delay increases by 1.055e+00 units. The coefficient for dep_delay3 suggests that for every unit increase in dep_delay cubed, arr_delay decreases by 2.081e-04 units.
